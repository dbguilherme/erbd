...
public class RandomSentenceSpout extends BaseRichSpout {
	...
	private String[] sentences = {
			"Pos UNOESC",     "ERBD:inteligencia de dados, banco de dados",  "escola regional de banco de           dados",  "processamento online de dados",  "banco de dados é top"
	};
	private int index = 0;
...
//  public void nextTuple() {
//    Utils.sleep(100);
//    String[] sentences = new String[]{sentence("ERBD 2018"), sentence("Sistemas de informação "),
//            sentence("banco de dados na web"), sentence("estou fazendo a oficina de processamento online de dados "), sentence("banco de dados é top")};
